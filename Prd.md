...
| 版本 | 日期 | 更新内容 | 状态 |
| :--- | :--- | :--- | :--- |
| **V1.3** | 2026-03-10 | **交互优化与AI升级**。<br>1. **时间控件重构**：支持直接数字输入 + 自定义简约时间选择器（替代原生picker）。<br>2. **关联功能完善**：实际时间记录新增”关联蓄水池”下拉框；修复关联下拉框展开问题。<br>3. **AI洞察精简**：输出更简短（3段），深度洞察整合为1段，语气更友好温暖。<br>4. **错误提示优化**：飞书权限错误(91403)给出明确的中文操作指引。 | **Current** |
